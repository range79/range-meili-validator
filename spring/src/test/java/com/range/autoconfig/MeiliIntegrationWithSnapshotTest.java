...
@Testcontainers
class MeiliIntegrationWithSnapshotTest {
    ...
    static final GenericContainer<?> meili =
            new GenericContainer<>("getmeili/meilisearch:latest")
                    ...
                    .withCopyFileToContainer(
                            MountableFile.forClasspathResource("snapshots"),
    ...
    static void overrideProps(DynamicPropertyRegistry registry) {
        ...
        registry.add("meili.startup.timeout", () -> 120);
    ...
    @Test
    void meiliIsFullyReady_withSnapshot() {
        validator.validate();
    }
